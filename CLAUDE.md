# CLAUDE.md — aim-vns-it

## Progetto
AI'm by VNS — sito italiano (primario, x-default)
URL live: https://www.aim-vns.com
Repo: github.com/vittorionegri68-alt/aim-vns-it
Cartella locale: D:\AI-m_by_VNS\SITO\aim-vns-it
...
## Struttura critica
- index-IT.html = shell Vite (schema.org, meta tag, GA4, noscript) — file sorgente
- index.html = COPIA OBBLIGATORIA di index-IT.html (richiesta da Vite build)
- public/resources/index-IT.html = shell pagina resources
- public/resources/index.html = COPIA OBBLIGATORIA di public/resources/index-IT.html
...
- MAI str_replace parziali su index.html o index-IT.html — ricreare SEMPRE il file completo
...
```bash
cp index-IT.html index.html
cp public/resources/index-IT.html public/resources/index.html
git add .
...
```bash
git config --global --add safe.directory D:/AI-m_by_VNS/SITO/aim-vns-it
git config --global user.name "Vittorio Negri"
git config --global user.email "info@aim-vns.com"
git remote add origin https://github.com/vittorionegri68-alt/aim-vns-it.git
git fetch origin
...
- index.html (copia di index-IT.html)
...
## Schema.org
Tipo: @graph unificato in index-IT.html
...
- guida-visibilita-ai-parte1-it.pdf
- guida-visibilita-ai-parte2-it.pdf
