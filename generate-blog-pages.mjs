...
const SITE_URL = "https://www.aim-vns.com";
...
<html lang="it">
  ...
  <body>
    <div class="wrap">
      <div class="top-nav">
        <a href="${SITE_URL}/#blog">← Torna al sito</a>
...
${bodyBlocks}
      ...
      <div class="ig-cta">
        <p>Vuoi sapere come ti trovano le AI? La prima analisi è gratuita.</p>
        <a class="btn-link" href="${CALENDLY_URL}" target="_blank" rel="noopener noreferrer">Analisi gratuita</a>
      </div>
      <footer><a href="${SITE_URL}/">AI'm by VNS - Torna alla home</a></footer>
    </div>
    <script>
      (function () {
