// Risultati.jsx â€” AI'm by VNS IT
// v2.0 â€” copy riscritta senza tecnicismi â€” giugno 2026
...
const cases = [
  {
    ...
    nota: 'Analisi aprile 2026 â€” prossimo aggiornamento luglio 2026',
  },
  {
    nome: 'RAB Romagna',
    luogo: 'Romagna, IT',
    ...
    nota: 'Analisi aprile 2026 â€” sistema validato prima della commercializzazione',
  },
]
      ...
      <div style={{ maxWidth: '1440px', margin: '0 auto', padding: '0 clamp(24px,4vw,64px)' }}>
        ...
        <div style={{ marginBottom: 'clamp(40px,5vw,64px)' }}>
          ...
          <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 'clamp(13px,1vw,15px)',
            ...
            Molte attività che analizziamo partono da un punteggio basso.
            Non è una brutta notizia: significa che sappiamo esattamente dove intervenire.
            La cosa peggiore non è avere un punteggio basso.
            È non sapere che ce l\'hai.
          </p>
        </div>
