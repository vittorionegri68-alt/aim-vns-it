      ...
      {(() => {
        ...
        return (
          <div style={{ marginTop: '3rem', paddingTop: '2rem', borderTop: '1px solid #1A1A1A' }}>
            <div style={{ fontFamily: "'Inter', sans-serif", fontWeight: 700, fontSize: '9px', color: '#AAAAAA', letterSpacing: '0.2em', textTransform: 'uppercase', marginBottom: '1rem' }}>Leggi anche</div>
            {altri.map((p, k) => (
