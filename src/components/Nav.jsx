      ...
      <div style={{
        ...
        <a href="#" style={{ display: 'flex', alignItems: 'baseline', gap: '8px', textDecoration: 'none' }}>
          <span style={{
            ...
            fontSize: '24px', letterSpacing: '0.04em', color: '#A0782A',
            textTransform: 'uppercase',
          }}>AI</span>
          <span style={{
            fontFamily: "'Oswald', sans-serif", fontWeight: 700,
            fontSize: '24px', letterSpacing: '0.04em', color: '#1A1A1A',
            textTransform: 'uppercase',
          }}>'M</span>
          <span style={{
            fontFamily: "'Inter', sans-serif", fontWeight: 700,
            fontSize: '9px', letterSpacing: '0.2em', color: '#1A1A1A',
            textTransform: 'uppercase', alignSelf: 'center',
            borderLeft: '1px solid #1A1A1A', paddingLeft: '8px', marginLeft: '2px',
          }}>BY VNS</span>
        </a>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          <div style={{ display: 'flex', gap: '4px', marginLeft: '8px' }}>
            {[
              { code: 'IT', url: 'https://www.aim-vns.com', active: true },
