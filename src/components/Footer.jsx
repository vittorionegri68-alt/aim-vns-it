    ...
    <footer style={{ background: '#050505', borderTop: '1px solid #0f0f0f' }}>
      <div style={{ maxWidth: '1440px', margin: '0 auto',
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between',
          ...
          borderBottom: '1px solid #0f0f0f', flexWrap: 'wrap', gap: '16px' }}>
          {/* Brand */}
          <div style={{ display: 'flex', alignItems: 'baseline', gap: '6px' }}>
            <span style={{ fontFamily: "'Oswald', sans-serif", fontWeight: 700,
              fontSize: '16px', letterSpacing: '0.04em', color: '#A0782A',
              textTransform: 'uppercase' }}>AI</span>
            <span style={{ fontFamily: "'Oswald', sans-serif", fontWeight: 700,
              fontSize: '16px', letterSpacing: '0.04em', color: '#1A1A1A',
              textTransform: 'uppercase' }}>'M</span>
            <span style={{ fontFamily: "'Inter', sans-serif", fontWeight: 700,
              fontSize: '8px', color: '#1A1A1A', letterSpacing: '0.2em',
              textTransform: 'uppercase', borderLeft: '1px solid #1A1A1A',
              paddingLeft: '6px' }}>BY VNS</span>
          </div>

          {/* Dominio */}
          <span style={{ fontFamily: "'Inter', sans-serif", fontWeight: 700,
            fontSize: '10px', color: '#A0782A', letterSpacing: '0.2em',
            textTransform: 'uppercase' }}>AIM-VNS.COM</span>
