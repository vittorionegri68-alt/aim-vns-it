...
const steps = [
  {
    num: '01',
    title: 'Analizziamo',
    desc: 'Controlliamo se ChatGPT, Perplexity e Gemini sanno che esisti. Ti diciamo com\'� la situazione adesso, con un punteggio chiaro. Nessun termine tecnico: solo cosa funziona e cosa no.',
  },
  {
    num: '02',
    title: 'Interveniamo',
    desc: 'Facciamo le modifiche necessarie al tuo sito perch� i motori AI capiscano chi sei, cosa fai e dove operi. Il blog automatico lavora in continuo per tenerti visibile nel tempo.',
  },
  {
    num: '03',
    title: 'Misuriamo',
